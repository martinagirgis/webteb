<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="qus.aspx.cs" Inherits="WebApplication14.qus" %>
    ...
    <form id="form2" runat="server">
        ...
        <nav dir="rtl" class="navbar navbar-expand-lg navbar-light bg-light nav1">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <asp:Button ID="Button3" runat="server" Text="تسجيل" class="btn sighn-btn" OnClick="Button3_Click" />

                    </div>
                    <div class="col-sm-3">
                        <asp:Button ID="Button4" runat="server" Text="دخول" class="btn sighn-btn" OnClick="Button4_Click" />
                    </div>
                    <div class="col-sm-6">
                        <div class="row">
                                    ...
                                    <div class="card-body">
                                        <p class="card-text">
                                            <div>
                                                ...
                                                <br />
                                                <br />
                                                <asp:DropDownList ID="DropDownList1" runat="server" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" class="form-control form-control-lg drop"></asp:DropDownList>
                                                <br />
                                                <br />
                                                <asp:Button ID="Button1" runat="server" Text="التالي" OnClick="Button1_Click" class="btn sighn-btn" />
                                                <br />
                                                <br />
                                                <asp:Label ID="Label2" runat="server" Text="Label" Visible="False"></asp:Label>
                                                <br />
                                                <br />
                                                <asp:DropDownList ID="DropDownList2" runat="server" Visible="False" class="form-control form-control-lg drop"></asp:DropDownList>
                                                <br />
                                                <br />
                                                <asp:Button ID="Button2" runat="server" Text="التالي" Visible="False" OnClick="Button2_Click" class="btn sighn-btn" />
                                                <br />
                                                <br />
                                                <asp:Button ID="Button5" runat="server" Text="أبدأ تشخيص جديد " OnClick="Button5_Click" class="btn sighn-btn" />
                                            </div>
                                        </p>
                                        <p class="card-text">
                                        </p>
